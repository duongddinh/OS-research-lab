...
- At **tight cache sizes**, ML **outperformed LRU** (48% vs 41% hit rate at size 64)
...
- ML strategies **work best in constrained environments** with:
  ...
  - Tight cache budgets
- In **specialized layers** (CDN edges, VM hypervisors, database page buffers), the tradeoffs are already practical and **production ML-augmented policies do exist**
