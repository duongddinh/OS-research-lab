...
| **RR + 2xML**       | Adds a regressor that predicts task duration and adjusts quantum on the fly (between 2-20 ms) |
...
- **RR + 2xML** added too many context switches when mispredicting large scans -> performance dropped

### Heavy Workload:
- **RR + ML** shaved off **10-15%** in average turnaround (95% of jobs fit in one slice)
- **RR + 2xML** added approx 3% more improvement, but still suffered on the monster jobs
